...
(function() {
  ...
  function Helpers($window, $location, $state, $http, $filter, ISO3166) {
    ...
    /**
     * Given a string of the type 'object.property.property', traverse the given
     * context (eg the current $state object) and return the value found at that path.
     *
     * @param objectPath
     * @param context
     * @returns {*}
